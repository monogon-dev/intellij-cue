...
public class CueImportLocationImpl extends CueCompositeElementImpl implements CueImportLocation {

  public CueImportLocationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CueVisitor visitor) {
    visitor.visitImportLocation(this);
  }
