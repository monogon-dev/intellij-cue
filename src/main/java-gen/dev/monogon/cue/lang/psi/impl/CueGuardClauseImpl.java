...
public class CueGuardClauseImpl extends CueCompositeElementImpl implements CueGuardClause {

  public CueGuardClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CueVisitor visitor) {
    visitor.visitGuardClause(this);
  }
