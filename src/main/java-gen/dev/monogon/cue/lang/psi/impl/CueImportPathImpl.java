...
public class CueImportPathImpl extends CueCompositeElementImpl implements CueImportPath {

  public CueImportPathImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CueImportLocation getImportLocation() {
    return findNotNullChildByClass(CueImportLocation.class);
  }
