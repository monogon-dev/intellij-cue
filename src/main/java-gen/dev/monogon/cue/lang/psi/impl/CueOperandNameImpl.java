...
public class CueOperandNameImpl extends CueCompositeElementImpl implements CueOperandName {
  ...
  @Override
  @Nullable
  public CueQualifiedIdent getQualifiedIdent() {
    return findChildByClass(CueQualifiedIdent.class);
  }
