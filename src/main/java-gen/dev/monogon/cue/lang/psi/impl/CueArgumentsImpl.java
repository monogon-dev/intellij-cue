...
public class CueArgumentsImpl extends CuePrimaryExprImpl implements CueArguments {

  public CueArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CueArgument> getArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CueArgument.class);
  }
