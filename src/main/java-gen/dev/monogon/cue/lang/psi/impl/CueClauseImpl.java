...
public class CueClauseImpl extends CueCompositeElementImpl implements CueClause {

  public CueClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CueStartClause getStartClause() {
    return findChildByClass(CueStartClause.class);
  }
