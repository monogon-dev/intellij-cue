...
public interface CueTypes {
  ...
  IElementType STRING_LIT = new CueCompositeElementType("STRING_LIT");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ALIAS_EXPR) {
        ...
        return new CueArgumentImpl(node);
      }
        ...
        return new CueLiteralImpl(node);
      }
        ...
        return new CueStringLitImpl(node);
      }
